...
#Get Flow
    ...
    if selected_task == "ItineraryPlanner":
        itinerary_data = {
            "city": context.city,
            "travel_duration": context.travel_duration,
            "pace": context.pace,
            "interests": context.interests,
            "must_see": context.must_see,
            "activity_type": context.activity_type,
        }
        print("[MAIN] Itinerary Data prepared.")
        
    
    context.poi_candidates = get_places_for_queries(generate_poi_query(itinerary_data))

    # print("Final\n\n\n")
    # print(context)

    print(ask_llm("Plan me a detailed itinerary with the following data:\n" + str(context) + "\nUser Query:\n" + demo_query))
